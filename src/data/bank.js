...
export const BANK = {
  ...
  stage2: [
    ...
    { id:"UC_2_3", title:"Vendor Mulai Telat", klaster:"B",
      ...
      waspadai:"Percaya buta (abai sinyal sekarang) atau perketat membabi buta (abai modal hubungan).", signal:null ,
    ...
    { id:"UC_2_4", title:"Scope Creep Halus", klaster:"A/C",
      ...
      cari:"Menyeimbangkan: hargai relasi tanpa membiarkan scope bocor; buat dampak terlihat dengan cara yang menjaga muka stakeholder.",
      waspadai:"Turuti semua karena utang budi (scope bocor) atau tolak kaku tanpa menavigasi relasi.", signal:null },
    { id:"UC_2_5", title:"Konflik Prioritas Antar-Stakeholder", klaster:"A/B",
      prompt:"Dua stakeholder dengan jabatan setara meminta tim mengerjakan hal berbeda lebih dulu, dan keduanya merasa paling mendesak. Anda di tengah.\n\nDua jalan:\n1. Bawa ke kriteria objektif (dampak, dependency), fasilitasi keputusan bersama.\n2. Naikkan ke atasan bersama untuk diputuskan.\n\nPilih satu dan jelaskan: kenapa pilihan itu, dan konsekuensi apa yang Anda terima?",
    ...
    { id:"UC_2_6", title:"Logika & Dependency", klaster:"A",
      ...
      waspadai:"Menjumlah semua (10 hari) tanpa paham paralelisasi. Atau melewatkan risiko vendor.", signal:null },
    ...
    { id:"UC_2_8", title:"Estimasi Terlalu Optimistis", klaster:"A/B",
      ...
      cari:"Membaca kenapa estimasi mungkin optimistis (tekanan manajemen), menggali tanpa mempermalukan. EQ + skeptisisme sehat.",
      waspadai:"Terima buta, atau memaksa pangkas. Abai tekanan psikologis di balik estimasi.", signal:null ,
